const url = 'https://api.akademiumkm.id';
export const endpoint = {
  ...
  searchShop: (lat, lng, value) =>
    `${url}/api/shops?q=${value}&lat=${lat}&lng=${lng}`,
  ...
  getShopByFilter: (lat, lng, categoryId) =>
    `${url}/api/shops?lat=${lat}&lng=${lng}&category_id=${categoryId}`,
  ...
  getCoursesDetails: id => `${url}/api/courses/${id}`,
  checkoutCourses: id => `${url}/api/courses/${id}/pay`,
};
